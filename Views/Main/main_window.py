...
"                                                        ")
        ...
        self.label_Target_Group_Error_Message = QtWidgets.QLabel(parent=self.groupBox_Target_Group)
        self.label_Target_Group_Error_Message.setText("")
        self.label_Target_Group_Error_Message.setObjectName("label_Target_Group_Error_Message")
        self.verticalLayout_5.addWidget(self.label_Target_Group_Error_Message)
    ...
    def retranslateUi(self, MainWindow_Main):
        ...
        self.groupBox_Target_Group.setTitle(_translate("MainWindow_Main", "Grupa docelowa"))
        self.comboBox_Target_Group.setPlaceholderText(_translate("MainWindow_Main", "Wybierz grupę docelową... "))
        self.comboBox_Target_Group.setItemText(0, _translate("MainWindow_Main", "Dzieci i młodzież"))
        self.comboBox_Target_Group.setItemText(1, _translate("MainWindow_Main", "Dorośli"))
        self.comboBox_Target_Group.setItemText(2, _translate("MainWindow_Main", "Emeryci"))
